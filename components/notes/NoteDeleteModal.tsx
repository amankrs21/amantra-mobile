...
export type NoteDeleteModalProps = { visible: boolean; onClose: () => void; onConfirm: () => Promise<void> | void; title: string };
        ...
        <Modal animationType="fade" transparent visible={visible} onRequestClose={onClose}>
            <SafeAreaView style={styles.overlay}>
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.subtitle}>You are about to remove <Text style={{ fontWeight: '700' }}>{title}</Text>. This action cannot be undone.</Text>
